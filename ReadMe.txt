...
controlDlg.h, controlDlg.cpp - the dialog
    These files contain your CControlDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in control.rc, which can be edited in Microsoft
	Visual C++.
